...
import { authorizeUrl, createCodeVerifier, isEtsyConfigured, originOf } from "@/lib/etsy-api";
...
export async function GET(request: Request) {
  ...
  const response = NextResponse.redirect(authorizeUrl(state, verifier, originOf(request)));
