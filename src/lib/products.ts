...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    sizes: [
      ...
      { name: "Long Sleeve / S", price: 44.99 },
      { name: "Long Sleeve / M", price: 44.99 },
      { name: "Long Sleeve / L", price: 44.99 },
      { name: "Long Sleeve / XL", price: 44.99 },
      { name: "Long Sleeve / 2XL", price: 47.99 },
      { name: "Long Sleeve / 3XL", price: 50.99 },
      { name: "Youth Short / S", price: 38.39 },
      { name: "Youth Short / M", price: 38.39 },
      { name: "Youth Short / L", price: 38.39 },
      { name: "Youth Short / XL", price: 38.39 },
