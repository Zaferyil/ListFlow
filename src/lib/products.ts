...
export const PRODUCTS: Product[] = [
  {
    ...
    sizes: [
      ...
      { name: "Toddler / 2T", price: 39.99 },
      { name: "Toddler / 3T", price: 39.99 },
      { name: "Toddler / 4T", price: 39.99 },
      { name: "Toddler / 5T", price: 39.99 },
      // Baby sizes are spelled out rather than coded. A buyer shopping for a
