...
export const PRODUCTS: Product[] = [
  {
    ...
    sizes: [
      { name: "Short Sleeve / S", price: 39.99 },
      { name: "Short Sleeve / M", price: 39.99 },
      { name: "Short Sleeve / L", price: 39.99 },
      { name: "Short Sleeve / XL", price: 39.99 },
      { name: "Short Sleeve / 2XL", price: 42.99 },
      { name: "Short Sleeve / 3XL", price: 45.99 },
      { name: "Long Sleeve / S", price: 39.99 },
      { name: "Long Sleeve / M", price: 39.99 },
      { name: "Long Sleeve / L", price: 39.99 },
      { name: "Long Sleeve / XL", price: 39.99 },
      { name: "Long Sleeve / 2XL", price: 42.99 },
      { name: "Long Sleeve / 3XL", price: 45.99 },
      { name: "Youth Short / S", price: 39.99 },
      { name: "Youth Short / M", price: 39.99 },
      { name: "Youth Short / L", price: 39.99 },
      { name: "Youth Short / XL", price: 39.99 },
      { name: "Short Sleeve / 2T", price: 39.99 },
      { name: "Short Sleeve / 3T", price: 39.99 },
      { name: "Short Sleeve / 4T", price: 39.99 },
      { name: "Short Sleeve / 5T", price: 39.99 },
      { name: "Short Sleeve / NB", price: 39.99 },
      { name: "Short Sleeve / 06M", price: 39.99 },
      { name: "Short Sleeve / 12M", price: 39.99 },
      { name: "Short Sleeve / 18M", price: 39.99 },
      { name: "Short Sleeve / 24M", price: 39.99 },
    ],
  ...
  },
  {
    ...
    requiredKeywords: [],
    colors: ["Black", "Forest", "Gold", "Gray", "Navy", "Red", "Royal", "White"],
    sizeLabel: "Size and Style",
    // Six garments in one run, adult through toddler, so the menu carries the
    // garment as well as the size — which is what the label above it is for.
    sizes: [
      { name: "Hooded / S", price: 54.99 },
      { name: "Hooded / M", price: 54.99 },
      { name: "Hooded / L", price: 54.99 },
      { name: "Hooded / XL", price: 54.99 },
      { name: "Hooded / 2XL", price: 57.99 },
      { name: "Hooded / 3XL", price: 60.99 },
      { name: "Hooded / 4XL", price: 63.99 },
      { name: "Hooded / 5XL", price: 66.99 },
      { name: "Sweatshirt / S", price: 49.99 },
      { name: "Sweatshirt / M", price: 49.99 },
      { name: "Sweatshirt / L", price: 49.99 },
      { name: "Sweatshirt / XL", price: 49.99 },
      { name: "Sweatshirt / 2XL", price: 52.99 },
      { name: "Sweatshirt / 3XL", price: 55.99 },
      { name: "Youth Hooded / YS", price: 52.99 },
      { name: "Youth Hooded / YM", price: 52.99 },
      { name: "Youth Hooded / YL", price: 52.99 },
      { name: "Youth Hooded / YXL", price: 55.99 },
      { name: "Youth Sweatshirt / YS", price: 39.99 },
      { name: "Youth Sweatshirt / YM", price: 39.99 },
      { name: "Youth Sweatshirt / YL", price: 39.99 },
      { name: "Youth Sweatshirt / YXL", price: 42.99 },
      { name: "Toddler Hoodie / 2T", price: 52.99 },
      { name: "Toddler Hoodie / 3T", price: 52.99 },
      { name: "Toddler Hoodie / 4T", price: 52.99 },
      { name: "Toddler Hoodie / 5T", price: 52.99 },
      { name: "Toddler Crewneck / 2T", price: 45.99 },
      { name: "Toddler Crewneck / 3T", price: 45.99 },
      { name: "Toddler Crewneck / 4T", price: 45.99 },
      { name: "Toddler Crewneck / 5T", price: 45.99 },
    ],
